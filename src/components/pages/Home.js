  ...
  return (
    <Container fluid className='wrapper'>
      ...
      <Row id='row'>
        ...
        <Col xl={6} id='txt-col' className='gx-0 text-light p-0' >
          <div id='txt'>
            <h5 id='h5txt' className='text-primary'>SO, YOU WANT TO TRAVEL TO SPACE</h5>
        ...
        <Col xl={6} id='btn-col' className='gx-0 text-light p-0'>
